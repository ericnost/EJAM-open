...
#' @keywords internal
#'
generate_demog_header <- function(title = 'Environmental and Residential Population Indicators') {
...
#' @keywords internal
#'
generate_ej_header <- function(title = 'Indexes') {
  paste0('<br>
 <div id=\"page-2-header\" class=\"header\" style=\"background-color: #005ea2;  color: white; text-align: center; padding: 20px 32px 10px 32px;\">
         ...
         'The summary and supplemental indexes are a combination of environmental and residential population information. For each of the environmental indicators, there is a Summary Index and a Supplemental Summary Index. The indexes for a selected area are compared to those for all other locations in the state or nation.</p>',
         '
        </div>
