...
ggplot(ratio.to.us.d.bysite, aes(x = `value`, y = `indicator`, fill = ..x..)) + # Please use `after_stat(x)` instead. Warning: The dot-dot notation (`..x..`) was deprecated in ggplot2 3.4.0.
  ...
  labs(title = 'Variations among Sites') +
